...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "axmadjon" => "axmadjon.xamidov@gmail.com" }
  # Or just: spec.author    = "axmadjon"
  # spec.authors            = { "axmadjon" => "axmadjon.xamidov@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/axmadjon"
  ...
  spec.source       = { :git => "https://github.com/axmadjon/ncnn.git", :branch => "main" }
